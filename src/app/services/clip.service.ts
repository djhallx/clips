...
export class ClipService implements Resolve<IClip | null> {
  ...
  creatClip(data: IClip): Promise<DocumentReference<IClip>> {
      // The add function tells Firebase to generate an id for the new record.
  ...
  getUserClips(sort$: BehaviorSubject<string>) {
    console.log("getUserClips(): begin.")
    return combineLatest([
      ...
      switchMap(values => {
        ...
        console.log('getUserClips() sort = ' + sort)
  ...
  async getClips() {
    ...
    this.pageClips.forEach(clip => {
      console.log("getClips(): screenshotURL: " + clip.screenshotURL)
    })

    this.pendingReq = false
    console.log("getClips(): end.")
  }
